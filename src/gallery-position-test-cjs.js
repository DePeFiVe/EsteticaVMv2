// Gallery Position Test Script (CommonJS version)
...
async function runTests() {
  ...
  if (!positionExists) {
    ...
    if (!canWrite) {
      ...
      console.log('  1. Check for database triggers or constraints');
      console.log('  2. Verify position column data type and constraints');
      console.log('  3. Review error logs for detailed failure reasons');
    }
  }}
