// Gallery Position Test Script (ESM version)
// This script diagnoses issues with gallery image position updates

// Use ESM import for Supabase client
...
async function runTests() {
  ...
  if (!positionExists) {
    ...
    if (!canWrite) {
      ...
      console.log('  1. Check for database triggers or constraints that may be blocking updates')};
  }
}
